    ...
    <div>
      <Section title='EDUCATION'>
        ...
        <Card title='Fullstack Open MOOC, 22 ECTS'>
          ...
          <Tags tags='Node.js, React (Native), Redux, TypeScript, Express, GraphQL, MongoDB/Apollo, Sequelize, Jest, Cypress' />
        </Card>
    ...
    <div>
      <Section title='SKILLS'>
        <Card title='JavaScript'>
          ...
          <Tags tags='Node.js, React (Native), Redux, TypeScript, Express, GraphQL, MongoDB/Apollo, Sequelize, Jest, Cypress, GatsbyJS, Tailwind CSS' />
        </Card>
        <Card title='.NET / C#'>
    ...
    <div>
      <Section title='MAIN PROJECTS'>
        ...
        <Card title='Koodimatskut.fi' titleUrl='https://koodimatskut.fi'>
          ...
          <Card title='To The Depths' titleUrl='https://www.youtube.com/watch?v=hu2dzJNLnBI&list=PL8IdD7AC_avEzrpin7zCnhaRYm3l91JJa&index=2'>
            <Subheading text='GameMaker: Studio, PlayFab, GameAnalytics, Google OAuth2.0' />
